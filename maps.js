...
let maps = [
  ...
  },
  {
    ...
    waves: [
      ...
      [[3, "od", pause], "od"],
      [["alert", "Tip: Slowing towers can't hurt shielded enemies, but they'll still slow them down."], [5, "gd"]],
      [[3, [3, "gd"], pause], pause, [2, [3, "gd"], pause], [3, "gd"]],
      [[2, [2, "od"], pause, [2, "od"], [2, pause]], [3, "yd"]],
      [[3, "rd", pause], "rd"],
      [[4, "od"]],
      [[20, "gd", pause], pause, [10, "yd", pause], pause, [5, "od", pause], pause, "rd"],
      [[2, "bd"], pause, [6, "rd"]],
      [[3, "rd", "od", pause], "rd", "od"],
      [],
      [],
      [["alert", "Tip: Slowing Towers and Long-Range Towers can remove enemies' shields with upgrades."]],
      [],
      [],
      [],
      [],
